...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func ensureApplicationIconForDirectRuns() {
        ...
        let candidates = [
            Bundle.main.url(forResource: "PKbrain", withExtension: "icns"),
            Bundle.main.url(forResource: "PKbrainStatus", withExtension: "png"),
            URL(fileURLWithPath: #filePath)
                .deletingLastPathComponent() // App
                .deletingLastPathComponent() // PKbrain
                .deletingLastPathComponent() // macos
                .deletingLastPathComponent() // PKbrainOS
    ...
    private func donateSpotlightActivities() {
        ...
        let bundleID = Bundle.main.bundleIdentifier ?? "io.github.mondary.pkbrain"
